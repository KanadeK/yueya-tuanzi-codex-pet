...
<p align="center">
  <img src="media/showcase.gif" alt="月牙团子九种 Codex 状态动画" width="240">
</p>

<p align="center">一个可直接加载到 Codex Desktop 的原创桌面宠物包。</p>

<p align="center">
  <a href="https://kanadek.github.io/yueya-tuanzi-codex-pet/">动画预览</a> |
...
[在 Codex 中安装月牙团子](codex://pets/install?name=%E6%9C%88%E8%96%AA%E5%96%B5&imageUrl=https%3A%2F%2Fraw.githubusercontent.com%2FKanadeK%2Fyueya-tuanzi-codex-pet%2Fmain%2Fpet%2Fspritesheet.webp&spriteVersionNumber=2)
...
```powershell
irm https://raw.githubusercontent.com/KanadeK/yueya-tuanzi-codex-pet/main/scripts/install.ps1 | iex
```

### macOS / Linux

```bash
curl -fsSL https://raw.githubusercontent.com/KanadeK/yueya-tuanzi-codex-pet/main/scripts/install.sh | sh
```
...
把 `pet/pet.json` 与 `pet/spritesheet.webp` 放入 `~/.codex/pets/yueya-tuanzi/`，然后在 **Settings > Pets** 中刷新并选择 **月牙团子**。使用 `/pet` 或 **Wake Pet** 唤醒她。
...
- 月牙团子是全新设计：橘奶油毛色、弯月眉斑、琥珀菱形眼、青绿色领巾与铃铛、双色尾环。
